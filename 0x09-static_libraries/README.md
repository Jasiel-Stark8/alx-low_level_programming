...
In this project, I learned about static libraries and created and
using them using the `ar`, `ranlib`, and `nm` commands.
...
* **0. A library is not a luxury but one of the necessities of life**
  * [libmy.a](./libmy.a): C Static library containing all the functions from previous tasks
  listed below:
    * `int _putchar(char c);`
    * `int _islower(int c);`
    * `int _isalpha(int c);`
  ...
  * [main.h](./main.h): This Header file contains the prototypes of all functions
  included in `libmy.a`.
